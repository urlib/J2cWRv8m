...
function ftpAdd(type) {
	...
	var index = layer.open({
		...
		content: "<form class='bt-form pd20 pb70' id='ftpAdd'>\
					...
					<div class='info-r'><input class='bt-input-text mr5' type='text' name='ftp_password' id='MyPassword' style='width:330px' value='"+(RandomStrPwd(16))+"' /><span title='"+lan.ftp.add_pass_rep+"' class='glyphicon glyphicon-repeat cursor' onclick='repeatPwd(16)'></span></div>\
					</div>\
					<div class='line'>\
