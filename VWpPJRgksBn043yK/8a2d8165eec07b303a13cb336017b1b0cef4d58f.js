    ...
    get_init: function () {
        ...
        setTimeout(function () {
            ...
            bt.system.check_update(function (rdata) {
                console.log(rdata, rdata.msg.is_beta === 1);
    ...
    check_update: function () {
        ...
        bt.system.check_update(function (rdata) {
            ...
            if (rdata.status === false) {
                var loading = bt.open({
                    type: 1,
                    title: '['+ bt.os + (rdata.msg.is_beta == 1 ? '测试版' : '正式版') + ']-更新版本',
                    area: '520px',
                    shadeClose: false,
                    ...
                    content: '<div class="setchmod bt-form">\
                                ...
                                <div class="update_version">当前版本：<a href="https://www.bt.cn/bbs/forum-2-1.html" target="_blank" class="btlink" title="查看当前版本日志">宝塔'+ bt.os + (rdata.msg.is_beta == 1 ? '测试版 ' + rdata.msg.beta.version : '正式版 ' + rdata.msg.version) + '</a>&nbsp;&nbsp;发布时间：' + (rdata.msg.is_beta == 1 ? rdata.msg.beta.uptime : rdata.msg.uptime) + '</div>\
            ...
            if (rdata.status === true) {
                ...
                var loading = bt.open({
                    type: 1,
                    title: '['+ bt.os + (is_beta === 1 ? '测试版' : '正式版') + ']-版本更新',
                    area: '520px',
                    shadeClose: false,
                    skin: 'layui-layer-dialog',
                    closeBtn: 2,                  
                    content: '<div class="setchmod bt-form" style="padding-bottom:50px;">\
                                    ...
                                    <div class="update_conter">\
                                        <div class="update_version">最新版本：<a href="https://www.bt.cn/bbs/forum-2-1.html" target="_blank" class="btlink" title="查看版本更新日志">宝塔'+ bt.os  + (is_beta === 1 ? '测试版' : '正式版') + rdata.version + '</a>&nbsp;&nbsp;更新日期：' + (result.msg.is_beta == 1 ? result.msg.beta.uptime : result.msg.uptime) + '</div>\
...
setTimeout(function () {   
    bt.send('get_soft_list', 'plugin/get_soft_list', { force:1 }, function (rdata) {
