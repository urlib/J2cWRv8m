...
var database = {
        ...
        bt.database.get_list(page, search, function (rdata) {
            ...
            var _tab = bt.render({
                ...
                columns: [
                    ...
                    {
                        field: 'type', title: '数据库类型', hide: bt.os == 'Linux' ? true : false, sort: function () {
                            database.get_list();
                        }
                    },
                    {
    ...
    upload_files: function (name) {
        ...
        bt_upload_file.open(path, '.sql,.zip', lan.database.input_up_type, function () {
